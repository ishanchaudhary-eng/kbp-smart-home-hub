        ...
        <div className="space-y-4 mb-8">
          {points.map((p, i) => (
            <motion.div
              ...
              whileHover={{ x: 6, boxShadow: "0 10px 30px -10px rgba(0,0,0,0.1)" }}
              className="flex items-center gap-4 bg-card border rounded-xl p-4 hover:shadow-md transition-shadow cursor-pointer"
            >
              <motion.div
